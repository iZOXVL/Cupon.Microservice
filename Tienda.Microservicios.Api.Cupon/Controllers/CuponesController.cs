...
namespace Tienda.Microservicios.Api.Cupon.Controllers
{
    ...
    public class CuponesController : ControllerBase
    {
        ...
        public async Task<ResponseDto> Get()
        {
            try
            {
                IEnumerable<Tienda.Microservicios.Api.Cupon.Models.Cupon>
        ...
        public async Task<ResponseDto> Get(int id)
        {
            try
            {
                Tienda.Microservicios.Api.Cupon.Models.Cupon
